...
| firewall_monitoring_email_root_alias       | empty                        | Email address to use in place of root.                       |
| firewall_monitoring_email_mailhub          | empty                        | SMTP server for sending mail.                                |
| firewall_monitoring_email_port             | 25                           | SMTP server tcp port.                                        |
| firewall_monitoring_email_rewritedomain    | empty                        | Re-write emails sent with this domain.                       |
| firewall_monitoring_email_hostname         | empty                        | Hostname of the sending device.                              |
| firewall_monitoring_email_fromlineoverride | NO                           | Override the 'From:' line of the address.                    |
| firewall_monitoring_email_usetls           | NO                           | Use TLS for SMTP authentication.                             |
| firewall_monitoring_email_usetls_cert      | NO                           | Use TLS certificate to authenticate against SMTP host.       |
| firewall_monitoring_email_usestarttls      | NO                           | Use Start TLS.                                               |
| firewall_monitoring_email_username         | empty                        | Username for SMTP authentication.                            |
| firewall_monitoring_email_password         | empty                        | Password for SMTP authentication.                            |
| firewall_monitoring_ssmtp_path             | "/usr/local/etc/ssmtp"       | Path for the SSMTP configuration.                            |
...
firewall_monitoring_email_root_alias: "noreply@mydomain.com"
firewall_monitoring_email_mailhub: "smtp.mydomain.com"
firewall_monitoring_email_rewritedomain: "mydomain.com"
firewall_monitoring_email_hostname: "firewall.mydomain.com"
```
